...
//        lateinit var backdrop: ColorBuffer
//
//        videoPlayer = FFMPEGVideoPlayer.fromURL("file:data/videos/demo.mp4")
//        videoPlayer.start()
//        backdrop = loadImage("data/images/space.png")
//        var frame = 0
//        var correct = 0
//
//        extend {
...
//                        vec2 uv = 1.0 - (c_screenPosition - vec2(sin(p_count*0.1+p_seconds*1.0)*40.0, 0.0)) /  textSize;
...
//                        """.trimIndent()
//                    }.parameter("texture", backdrop)
//                     .parameter("count", (index+correct))
